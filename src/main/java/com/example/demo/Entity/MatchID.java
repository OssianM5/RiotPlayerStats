...
@Entity
@Table(name = "matchid") // Optional: explicitly specify table name
public class MatchID {
    ...
    public MatchID(Integer ID, String matchID, String puuid0, String puuid1, String puuid2, String puuid3, String puuid4, String puuid5, String puuid6, String puuid7, String puuid8, String puuid9) {
        this.ID = ID;
